    ...
    <div className='scroll-smooth text-slate-900'>
      ...
      <main className='pt-16'>
        ...
        <section id='introduccion' className='max-w-3xl mx-auto px-4 md:px-6 mt-16'>
          ...
          <div className='prose mt-3 text-slate-700'>
            <p>Cada día tiene: mapa, timeline, destinos, sabores, momentos y galería (descargable). Las fotos van en <code>/public/fotos</code> con nombres como <code>dia1-1.jpg</code>.</p>
          </div>
        </section>
